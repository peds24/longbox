  ...
  return (
    <ThemedView style={styles.container}>
      <SafeAreaView style={styles.safeArea} edges={['bottom']}>
        ...
        <Pressable onPress={lookup} style={[styles.button, { backgroundColor: theme.backgroundElement }]}>
          <ThemedText type="smallBold">Look Up</ThemedText>
        </Pressable>

        {resolving && <ActivityIndicator style={styles.spinner} />}
        ...
        {unresolvedCode && (
          <View style={styles.messageBox}>
            ...
            <Pressable
              ...
              <ThemedText type="smallBold">Search by Title Instead</ThemedText>
            </Pressable>
          </View>
        )}
